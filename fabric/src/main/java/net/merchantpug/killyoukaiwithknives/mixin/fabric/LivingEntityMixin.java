...
public abstract class LivingEntityMixin extends Entity {
    ...
    private static AttributeSupplier.Builder killyoukaiwithknives$addAirSpeedAttribute(AttributeSupplier.Builder original) {
        original.add(KillYoukaiAttributes.AIR_SPEED);
        return original;
    }
